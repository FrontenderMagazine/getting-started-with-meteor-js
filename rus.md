...
технологию (вы сами должны в этом разобраться). Её цель — дать быстрый
...
стандартных пакетов, которые вы найдёте почти в каждом серьёзном
...
*   [Compose][21] — хостинг MongoDB с Oplog
...
- [Best Learning Resources for Meteor.js][154] от Cтефан Хочхаус (Stephan Hochhaus)
- [Learn Meteor.js Properly][155], которую написал Ричард (Richard)
