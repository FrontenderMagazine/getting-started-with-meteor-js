...
Что должен знать веб-разработчик, стремящийся создавать приложения 
на [Meteor][2]?
...
Когда вы через тернии пробираетесь к новым знаниям, хорошо бы иметь под 
...
Теперь, когда вы изучили содержимое предыдущего списка, вы достойны 
чести познать силу и великолепие Meteor!
...
минимум ключевых пакетов из подпроектов, которые вам нужно знать.
