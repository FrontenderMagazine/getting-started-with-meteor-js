...
Списки в статье специально даны в определённом порядке, если не сказано 
...
Чтобы не заблудиться в море новой информации, хорошо бы иметь под 
...
Теперь, когда изучены перечисленные выше технологии, вы достойны 
...
пакеты, которые глубоко интегрированы в платформу Meteor, и они расширяют
